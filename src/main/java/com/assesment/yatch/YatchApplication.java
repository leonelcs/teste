	...
	public CommandLineRunner loadData(InterestRateRepository repository, MortgageRepository mortRepository) {
		return (args) -> {
			...
			List<InterestRate> irList = Arrays.asList( new InterestRate[] {
							...
							new InterestRate(5,BigDecimal.valueOf(4.395)),
							new InterestRate(6,BigDecimal.valueOf(4.355)),
							new InterestRate(7,BigDecimal.valueOf(4.315)),
							new InterestRate(8,BigDecimal.valueOf(4.295)),
							new InterestRate(9,BigDecimal.valueOf(4.255)),
							new InterestRate(10,BigDecimal.valueOf(4.215)),
							new InterestRate(11,BigDecimal.valueOf(4.195)),
							new InterestRate(12,BigDecimal.valueOf(4.155)),
							new InterestRate(13,BigDecimal.valueOf(4.115)),
							new InterestRate(14,BigDecimal.valueOf(4.095)),
							new InterestRate(15,BigDecimal.valueOf(4.055)),
							new InterestRate(16,BigDecimal.valueOf(4.015)),
							new InterestRate(17,BigDecimal.valueOf(3.995)),
							new InterestRate(18,BigDecimal.valueOf(3.955)),
...
//			mort.setMaturityPeriod(15);
//			mort.setIsFeasible(true);
//			
